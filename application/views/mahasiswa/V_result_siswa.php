...
<legend><h5>DATA CALON MAHASISWA</h5></legend>

<!--TABEL DATA MAHASISWA-->
<div class="table-responsive">

<table class="table table-bordered table-striped table-hover" style="border-right: 10px;">
...
<a href="<?php echo base_url().'calon_mahasiswa/add';?>" title="TAMBAH DATA" class="btn btn-red " ><span class="glyphicon glyphicon-plus"></span> Tambah</a>
<a href="<?php echo base_url().'calon_mahasiswa/index_mahasiswa';?>" title="REFRESH" class="btn btn-danger"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
</div>
</div>      
